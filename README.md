...
![Version](https://img.shields.io/badge/version-0.132b-purple)
...
VERSION=0.132b BUILD_NUMBER=134 ARCH=arm64 ./Scripts/build-release.sh

# Intel
VERSION=0.132b BUILD_NUMBER=134 ARCH=x86_64 ./Scripts/build-release.sh
```
